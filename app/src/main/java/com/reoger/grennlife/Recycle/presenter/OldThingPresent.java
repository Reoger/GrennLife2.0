...
//    }
    ...
    @Override
    public void doGetData(final TypeGetData type) {
        switch(type){
            case INITIALZATION:
                mDataNum = 10;
                break;
        ...
        query.findObjects(new FindListener<OldThing>() {
            ...
            public void done(List<OldThing> list, BmobException e) {
                if(e == null){
                    mIOldthing.onGetResultData(true,type,list);
                }else{
                    mIOldthing.onGetResultData(false,type,null);
                }
            }
        });
    }
